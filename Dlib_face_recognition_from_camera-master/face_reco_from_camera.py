...
class Face_Recognizer:
    ...
    def show_chinese_name(self):
        ...
        if self.current_frame_face_cnt >= 1:
            ...
            self.face_name_known_list[0] = '袁涛'.encode('utf-8').decode()
            self.face_name_known_list[1] = '袁涛1'.encode('utf-8').decode()
                        ...
                        for k in range(len(faces)):
                            ...
                            # 6. 寻找出最小的欧式距离匹配 / Find the one with minimum e-distance
                                ...
                                if min(current_frame_e_distance_list) < 0.4:
                                    ...
                                    logging.info("\n查到此人 姓名： %s 所属部门：%d ", self.face_name_known_list[similar_person_num], similar_person_num)
                                else:
